...
router.post('/sessions/start', (0, validation_1.validateRequest)(validation_1.schemas.startSession), async (req, res) => {
    try {
...
router.put('/sessions/:id/complete', (0, validation_1.validateRequest)({
    ...validation_1.schemas.completeSession,
...
router.get('/stats', async (req, res) => {
    try {
        ...
        const sessionDates = recentSessions.map(s => new Date(s.completed_at).toDateString());
